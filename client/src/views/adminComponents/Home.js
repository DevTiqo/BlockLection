                ...
                <Row>
                    <div className="col-md-4">
                        <div className="card mb-4 box-shadow">
                            <img className="card-img-top" src="/images/Capture.png" alt="Card image cap" />
                    ...
                    <div className="col-md-4">
                        <div className="card mb-4 box-shadow">
                            <img className="card-img-top" src="/images/imagesBlock.png" alt="Card image cap" />
                            <div className="card-body">
                                <h3>Features</h3>
                                <p className="card-text">This is a wider card with supporting text below as a natural lead-in to
                                additional content. This content is a little bit longer.</p>
                    ...
                    <div className="col-md-4">
                        <div className="card mb-4 box-shadow">
                            <img className="card-img-top" src="/images/image.png" alt="Card image cap" />
